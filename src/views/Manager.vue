  ...
  <div class="manager-container">
    <div class="manager-header">
      <div class="manager-header-left">
        ...
        <div class="title">水韵江苏文旅服务网站管理后台</div>
      </div>
      ...
      <div class="manager-main-left">
        ...
        >
          ...
          <el-sub-menu index="1">
            ...
            <!-- 1. 核心修改：订单信息 → 预约信息 -->
            <el-menu-item index="/manager/orders">预约信息</el-menu-item>
            <!-- 2. 优化：旅游商品 → 旅游产品管理（更贴合预约场景） -->
            <el-menu-item index="/manager/tourism">旅游产品管理</el-menu-item>
...
const logout = () => {
  ...
  router.push('/login')
  ElMessage.success('退出登录成功！') // 新增提示，提升体验
}
